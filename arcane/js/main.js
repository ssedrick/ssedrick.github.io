...
var CircleButton = React.createClass({
   ...
   render: function () {
      return React.createElement(
         "button",
         { type: this.props.type, onclick: this.props.click, id: this.props.id, className: "circle-button mdl-button mdl-js-button mdl-button--fab mdl-button--colored mdl-js-ripple-effect" },
         React.createElement(
            "i",
   ...
   render: function () {
      return React.createElement(
         ...
         React.createElement(
            'div',
            { className: 'row' },
            React.createElement('div', { className: 'col-xs-3 col-md-1 col-lg-3' }),
            React.createElement(
               'div',
               { className: 'col-xs-2 col-md-3 col-lg-2' },
               React.createElement(RectangleButton, { type: 'button', id: 'previous', name: 'skip_previous', click: '' })
            ),
            React.createElement(
               'div',
               { className: 'col-xs-2 col-md-3 col-lg-2' },
               React.createElement(CircleButton, { type: 'button', id: 'play', name: 'play_arrow', click: '' })
            ),
            React.createElement(
               'div',
               { className: 'col-xs-2 col-md-3 col-lg-2' },
               React.createElement(RectangleButton, { type: 'button', id: 'next', name: 'skip_next', click: '' })
            ),
            React.createElement('div', { className: 'col-xs-3 col-md-1 col-lg-3' })
         )
      );
         ...
         React.createElement(
            ...
            React.createElement(
               ...
               React.createElement(
                  'div',
                  { className: 'col-xs-6' },
                  React.createElement(MenuTile, null)
               ),
               React.createElement(
                  'div',
                  { className: 'col-xs-6' },
...
var MenuTile = React.createClass({
   ...
   render: function () {
      return React.createElement("div", { className: "tile mdl-card mdl-shadow--5dp" });
   }
});
